...
3. The build process installs PythonPlot. This step is only needed if PythonPlot is used. If you are not using PythonPlot, edit the .devcontainer/Dockerfile as needed. 
